...
resource "openstack_compute_instance_v2" "bastion" {
  ...
  provisioner "local-exec" {
    ...
    command = "sed s/USER/${var.ssh_user}/ /Users/v44ti/Documents/gitEnv/Kubespray/kubespray/contrib/terraform/openstack/ansible_bastion_template.txt | sed s/BASTION_ADDRESS/${var.bastion_fips[0]}/ > /Users/v44ti/Documents/gitEnv/Kubespray/kubespray/inventory/my-kube/group_vars/no_floating.yml"
  }
}
...
resource "openstack_compute_instance_v2" "k8s_master" {
  ...
  provisioner "local-exec" {
    ...
    # command = "sed s/USER/${var.ssh_user}/ ../../contrib/terraform/openstack/ansible_bastion_template.txt | sed s/BASTION_ADDRESS/${element(concat(var.bastion_fips, var.k8s_master_fips), 0)}/ > ${var.group_vars_path}/no_floating.yml"
    command = "sed s/USER/${var.ssh_user}/ /Users/v44ti/Documents/gitEnv/Kubespray/kubespray/contrib/terraform/openstack/ansible_bastion_template.txt | sed s/BASTION_ADDRESS/${element(concat(var.bastion_fips, var.k8s_master_fips), 0)}/ > /Users/v44ti/Documents/gitEnv/Kubespray/kubespray/inventory/my-kube/group_vars/no_floating.yml"
  }
}
...
resource "openstack_compute_instance_v2" "glusterfs_node_no_floating_ip" {
  ...
  availability_zone = element(var.az_list, count.index)
  image_name        = "Ubuntu-20.04.3-Focal-x64-2021-12" #var.gfs_root_volume_size_in_gb == 0 ? local.image_to_use_gfs : null #TODO: Something is off with gluster_fs vars. Had to hardcode it.
